"use strict";
var _a;
Object.defineProperty(exports, "__esModule", { value: !0 }), (exports.LogUpload = void 0);
  ...
  static Init() {
    ...
    e
      ...
      : Log_1.Log.CheckError() &&
        Log_1.Log.Error("LogUpload", 9, "CDN下发数据未配置腾讯云对象存储相关配置！"),
      ...
      this.Yvi &&
        (Info_1.Info.IsPcOrGamepadPlatform() && UE.KuroTencentCOSLibrary.EnableAutoSendWhenExit(),
        Info_1.Info.IsMobilePlatform()) &&
        UE.KuroLauncherLibrary.GetNetworkConnectionType() === NetworkDefine_1.ENetworkType.WiFi &&
  ...
  static eMi() {
    ...
    ControllerHolder_1.ControllerHolder.KuroSdkController.CanUseSdk() &&
      (r = ModelManager_1.ModelManager.LoginModel.GetSdkLoginConfig()?.Uid
        ...
        : "0"),
      (this.tMi = r + "-" + e),
      Log_1.Log.CheckInfo() && Log_1.Log.Info("Log", 37, "获取日志上传UID", ["UID", this.tMi]);
  }
}
(exports.LogUpload = LogUpload),
  ...
  (LogUpload.PreSendFiles = (o) => {
    ...
    var e,
      n,
      s = UE.KuroLauncherLibrary.GameSavedDir() + _a.oMi;
    UE.KuroStaticLibrary.FileExists(s) &&
      ((n = ((e = ""), puerts_1.$ref)("")),
      ...
      0 < (a = _a.rMi ? a.filter((e) => !_a.rMi.Paths.includes(e)) : a).length &&
