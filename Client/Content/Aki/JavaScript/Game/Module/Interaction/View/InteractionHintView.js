      ...
      (this.sci = () => {
        Log_1.Log.CheckDebug() &&
          ...
          this.wui
            ...
            : (this.bui = TimerSystem_1.TimerSystem.Next(this.yAa));
      }),
      (this.yAa = () => {
        this.aci(),
          Log_1.Log.CheckDebug() &&
  ...
  nci() {
    ...
    (!t?.Valid ||
      ...
      this.InteractPawn(this.Nui)
        ? (this.Pui.splice(this.Nui, 1), this.EAa(this.Pui))
        : (this.Nui++, this.nci()),
      this.Oui >= this.kui)) &&
      this.Cci();
  }
