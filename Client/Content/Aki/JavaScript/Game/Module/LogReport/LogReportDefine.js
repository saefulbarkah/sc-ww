...
class ReactionLogRecord extends PlayerCommonLogData {
  constructor() {
    super(...arguments), (this.event_id = "102703"), (this.s_battle_id = ""), (this.s_reports = "");
  }
}
...
class ExploreToolUseLogData extends PlayerCommonLogData {
  constructor() {
    super(...arguments), (this.event_id = "1026"), (this.i_tool_id = ""), (this.o_report = []);
  }
}
...
class MailBindClickEvent extends PlayerCommonLogData {
  constructor() {
    super(...arguments), (this.event_id = "1051"), (this.i_language = 0), (this.i_if_binded = 0);
  }
}
...
class SdkStartReview extends PlayerCommonLogData {
  constructor() {
    super(...arguments), (this.event_id = "1044"), (this.s_channel = ""), (this.i_id = 0);
  }
}
