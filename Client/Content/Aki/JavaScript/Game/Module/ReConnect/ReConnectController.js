...
function reportReconnectProcess(e, n = Protocol_1.Aki.Protocol.O4n.NRs) {
...
class ReConnectController extends UiControllerBase_1.UiControllerBase {
  ...
  static async pso() {
    var e = Net_1.Net.GetDownStreamSeqNo(),
      ...
      o = new Protocol_1.Aki.Protocol.mss(),
      e =
        ((o.q5n = ModelManager_1.ModelManager.PlayerInfoModel.GetId()),
        (o.lHn = e),
        (o.l7n = n),
        (o._Hn = ModelManager_1.ModelManager.ReConnectModel.ReconvTraceId),
    ...
    if (e.O4n !== Protocol_1.Aki.Protocol.O4n.NRs)
      return (
        ...
        reportReconnectProcess(n, e.O4n),
        new ReconnectResult(1, n, e.O4n)
      );
    ...
    o = Number(MathUtils_1.MathUtils.LongToBigInt(e.Mws));
    return (
...
(exports.ReConnectController = ReConnectController),
  ...
  (ReConnectController.Iso = (e, n = void 0) => {
    if (
      (Net_1.Net.Disconnect(1),
      ...
      TimerSystem_1.TimerSystem.Delay(() => {
        ModelManager_1.ModelManager.ReConnectModel.IsReConnectIdSame() &&
          ReConnectController.gso(o).then(
            ReConnectController.Mso,
            ReConnectController.Eso
          );
      }, o),
