...
class LoginModel extends ModelBase_1.ModelBase {
  ...
  OnInit() {
    return (
      (this.BornMode = 1),
      (this.BornLocation = new Protocol_1.Aki.Protocol.Pks()),
      (this.XK = LoginDefine_1.ELoginStatus.Init),
      (this.hEi = 0),
      (this.dTa = UE.KuroStaticLibrary.GetDeviceCPU()),
      (this.CTa = UE.KuroRenderingRuntimeBPPluginBPLibrary.GetRHIDeviceName()),
  ...
  AddDataTableServers() {
    if (this.$Mi && GlobalData_1.GlobalData.World) {
      var t = DataTableUtil_1.DataTableUtil.GetAllDataTableRow(14);
      if (t)
        for (const e of t)
          this.$Mi.push(new ServerConfig(e.IP, e.Port, e.Name, e.Order));
    }
  }
  CleanConfig() {
    (this.QMi = void 0),
  ...
  TryGetRealServerPort() {
    ...
    return t ? ((this.Zqn = void 0), t) : this.GetServerPort();
  }
  GetCustomServerPort() {
    return this.Zqn;
  }
  ...
  CheckBackToGameFailCount() {
    return ++this.Asa, this.Asa <= this.TryBackToGameMaxCount;
  }
}
