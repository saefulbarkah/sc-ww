"use strict";
Object.defineProperty(exports, "__esModule", { value: !0 }), (exports.LogController = void 0);
...
class LogController extends ControllerBase_1.ControllerBase {
  static OnInit() {
    return Net_1.Net.Register(15884, this.SLn), !0;
  }
  static OnClear() {
    return Net_1.Net.UnRegister(15884), !0;
  }
  static qfr(o) {
    ...
    (l.i_area_id = ModelManager_1.ModelManager.AreaModel.AreaInfo.AreaId),
      ...
      Global_1.Global.BaseCharacter
        ? ((r = Global_1.Global.BaseCharacter.D_K2_GetActorLocation()),
          ...
          e ? this.qfr(l) : LogReportController_1.LogReportController.LogReport(l))
        : Log_1.Log.CheckError() &&
          Log_1.Log.Error("Battle", 4, "日志上报-单机大世界死亡，当前不存在Global.BaseCharacter", [
            "roleId",
            o,
          ]);
  }
  ...
  static GetSkillButtonDebugInfo() {
    ...
    for (const l of ModelManager_1.ModelManager.SkillButtonUiModel.GetAllSkillButtonEntityData()) {
      ...
      if (l.SkillButtonDataMap)
        for (const a of l.SkillButtonDataMap.values()) t.Button.push(a.GetDebugInfo());
      o.push(t);
    }
    ...
    if (e?.IsEnable && e.SkillButtonDataMap) {
      ...
      for (const n of e.SkillButtonDataMap.values()) r.Button.push(n.GetDebugInfo());
      o.push(r);
    }
    return o;
  }
  static OutputDebugInfo() {
    var o = new DebugInfo(
      Protocol_1.Aki.Protocol.i4s[ModelManager_1.ModelManager.GameModeModel.InstanceType],
      ...
      [
        Global_1.Global.BaseCharacter.CharacterActorComponent.ActorLocationProxy.X.toFixed(2),
        Global_1.Global.BaseCharacter.CharacterActorComponent.ActorLocationProxy.Y.toFixed(2),
        Global_1.Global.BaseCharacter.CharacterActorComponent.ActorLocationProxy.Z.toFixed(2),
      ],
    ...
    return (
      ModelManager_1.ModelManager.CreatureModel.GetAllEntities().forEach((o) => {
        var t,
          ...
          l = o.Entity,
          a = l?.GetComponent(3),
          n = l?.GetComponent(198);
        l &&
          a &&
          n &&
          ((t = l.GetComponent(0)),
          (e = l.GetComponent(194)),
          (r = l.GetComponent(161)),
          (l = l.GetComponent(93)),
          (g +=
            `
***********
实体信息: EntityHandleId: ${
              o.Id
            }, CreatureDataId: ${t?.GetCreatureDataId()}, PbDataId: ${t?.GetPbDataId()}, Type: ${t?.GetEntityType()}, 位置: ${[
              a?.ActorLocationProxy.X.toFixed(2),
              a?.ActorLocationProxy.Y.toFixed(2),
              a?.ActorLocationProxy.Z.toFixed(2),
            ]}, IsInFighting: ${l?.IsInFighting}
Buff信息: ${n
              ?.GetAllBuffs()
              .map((o) => `${o.Id} ${o.Handle} ` + o.StackCount + (o.IsActive() ? "" : "(非激活)"))
              .join("|")}
...
` + g
  ...
  static RequestOutputDebugInfo() {
    ...
    (o.GKn = LogController.OutputDebugInfo()),
      Net_1.Net.Call(17652, o, (o) => {
        o && Log_1.Log.CheckInfo() && Log_1.Log.Info("Log", 37, "[Debug]服务器端战斗状态信息打印");
      });
  }
}
